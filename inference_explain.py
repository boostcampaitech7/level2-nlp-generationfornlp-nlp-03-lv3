...
CHAT_TEMPLETE_PLUS_EXP = {
    "unsloth/Qwen2.5-32B-Instruct-bnb-4bit": QWEN_CHAT_TEMPLETE_PLUS_EXP,
}
RESPONSE_TEMP = {
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", type=str, default="./resources/checkpoint/24-fold-3/checkpoint-583")
    parser.add_argument("--dataset_name", type=str, default="./resources/test_explain.csv")
    ...
    dm = CausalLMDataModule(
        ...
        CHAT_TEMPLETE_PLUS_EXP[args.model_name_or_path],
        mode='inference'
    )
