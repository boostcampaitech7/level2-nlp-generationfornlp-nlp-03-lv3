...
def inference_by_logit(model, dataset, raw_dataset, tokenizer):
    ...
    pd.DataFrame(infer_results).to_csv("./output/kice_only_output.csv", index=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", type=str, default="./resources/checkpoint/trainQwen2.5-32B-Instruct-bnb-4bit/checkpoint-337p")
