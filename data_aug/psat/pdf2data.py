...
file_path = "./aug_src/2022/2. 언어논리(나).pdf" # TO_DO 문제지 파일 명
...
ans_df=pd.read_csv("./aug_src/2022/answer.csv") # TO_DO pdf2ans.py 결과물 파일명
...
total_data.to_csv("./aug_dst/2022/extract_from_pdf.csv", encoding='utf-8-sig') # TO_DO 저장할 파일명,경로명