...
sys.path.append("../")
from model.dpr import BiEncoderDataset
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="snumin44/biencoder-ko-bert-context", help="Directory of pretrained encoder model")
    parser.add_argument("--wiki_path", type=str, default="../resources/wikidump", help="Path of wiki dump")
    parser.add_argument("--valid_data", type=str, required=False, help="Path of validation dataset")
