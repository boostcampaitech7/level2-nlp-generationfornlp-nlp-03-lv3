...
### 코드 실행 방안
- `data_aug/2_검정고시` 폴더 안 코드 실행
- 실행 후 나온 output에 대해 수작업으로 학습 데이터 만듦
- 관련 데이터는 `resources/aug/검정고시` 확인
...
### 코드 실행 방안
- `data_aug/2_kbs_korean` 폴더 안 `01.pdf_to_txt_files.txt`를 참고하여 코드 실행
- 실행 후 나온 output에 대해 `02.manual_processing.ipynb` 기반으로 수작업으로 학습 데이터 만듦
- 관련 데이터는 `resources/aug/kbs_korean` 확인
...
### 코드 실행 방안
- `data_aug/2_psat` 폴더 안 코드 순차적으로 실행
- 관련 데이터는 `resources/aug/psat` 확인
...
### 코드 실행 방안
- `data_aug/2_공무원시험기출문제` 폴더 안 코드 순차적으로 실행
...
### 코드 실행 방안
- `data_aug/2_korquad` 폴더 안 코드 순차적으로 실행
